...
public class ColumnContentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void setHomeList(ColumnContentList homeList) {
        mList.clear();
        mList.addAll(homeList.getDatas());
        notifyDataSetChanged();
    }

    public void addHomeList(ColumnContentList homeList) {
...
//        notifyDataSetChanged();
    ...
    static class HomeListItemViewHolder extends RecyclerView.ViewHolder {
        ...
        void bindHomeListItem(ColumnContentList.DatasBean homeListDatasBean) {
