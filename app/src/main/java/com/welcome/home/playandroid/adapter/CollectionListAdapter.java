...
public class CollectionListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<CollectList.DatasBean> mList;
    ...
    public void setHomeList(CollectList homeList) {
        mList.clear();
        mList.addAll(homeList.getDatas());
        notifyDataSetChanged();
    }

    public void addHomeList(CollectList homeList) {
    ...
    static class HomeListItemViewHolder extends RecyclerView.ViewHolder {
        ...
        void bindHomeListItem(CollectList.DatasBean homeListDatasBean) {
